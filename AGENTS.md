...
- **Resources**: `src/Resources/` - Fluent API layer (SessionResource, QuestionResource, EventResource, ProviderResource)
...
- REST + SSE endpoints
- Core resources: sessions, messages, events, permissions, providers
